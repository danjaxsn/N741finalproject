...
CKDu_keyword <- c(searchTwitter("chronic kidney disease of unknown etiology", n=5))
ERCnt_keyword <- c(searchTwitter("enfermedad renal crónica no tradicional", n=5))
MeN_keyword <- c(searchTwitter("mesoamerican nephropathy", n=5))
CINAC_keyword <- c(searchTwitter("chronic interstitial nephritis in agricultural communities", n=5))
Climate_Change <- c(searchTwitter("climate change+health", n=5))
#Search for tweets that contain the hashtags of interest for this project. 
CKDu_hashtag <- c(searchTwitter("#CKDu", n=5))
ERCnt_hashtag <- c(searchTwitter("#ERCnt", n=5))
CINAC_hashtag <- c(searchTwitter("#CINAC", n=5))
MeN_hashtag <- c(searchTwitter("#MeN", n=5))
